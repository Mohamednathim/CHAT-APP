      ...
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="btn btn-block btn-sm mt-8 bg-gray-900 text-gray-400 border-none h-10 hover:text-info hover:bg-gray-900"
              disabled={loading}
            >
              {loading ? (
          ...
          <Link
            to="/signup"
            className="text-sm text-gray-400 hover:text-info mt-4 inline-block"
          >
